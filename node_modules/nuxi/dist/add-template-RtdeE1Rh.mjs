...
import { f as me, g as ye, n as logger, u as ge } from "./logger-CtlB9piy.mjs";
...
var add_template_default = defineCommand({
	...
	async run(ctx) {
		...
		ge(colors.cyan("Adding template..."));
		...
		ye(`Generated a new ${colors.cyan(templateName)}!`);
	}
});
//#endregion
