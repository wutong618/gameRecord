...
import { c as Se, g as ye, n as logger, o as Me, u as ge } from "./logger-CtlB9piy.mjs";
...
import { n as clearDir } from "./fs-qJl3Qqxr.mjs";
...
var analyze_default = defineCommand({
	...
	async run(ctx) {
		...
		ge(colors.cyan("Analyzing bundle size..."));
		...
		} else ye("✨ Analysis build complete!");
	}
});
//#endregion
