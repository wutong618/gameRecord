...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestURL, getResponseHeader, setResponseHeaders, removeResponseHeader, appendResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/dukkha/gameRecord/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { promises } from 'node:fs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/dukkha/gameRecord/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/dukkha/gameRecord/node_modules/devalue/index.js';
import destr from 'file:///Users/dukkha/gameRecord/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/dukkha/gameRecord/node_modules/ufo/dist/index.mjs';
import { hash as hash$1 } from 'file:///Users/dukkha/gameRecord/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/dukkha/gameRecord/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/dukkha/gameRecord/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/dukkha/gameRecord/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/dukkha/gameRecord/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/dukkha/gameRecord/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/dukkha/gameRecord/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/dukkha/gameRecord/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/dukkha/gameRecord/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/dukkha/gameRecord/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/dukkha/gameRecord/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/dukkha/gameRecord/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/dukkha/gameRecord/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/dukkha/gameRecord/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/dukkha/gameRecord/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/dukkha/gameRecord/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/dukkha/gameRecord/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/dukkha/gameRecord/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/dukkha/gameRecord/node_modules/unhead/dist/index.mjs';
import { unref, version } from 'file:///Users/dukkha/gameRecord/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///Users/dukkha/gameRecord/node_modules/@unhead/shared/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/dukkha/gameRecord/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dukkha/gameRecord"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dukkha/gameRecord/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dukkha/gameRecord/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dukkha/gameRecord/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/dukkha/gameRecord/.data/kv"}));
...
const rootDir = "/Users/dukkha/gameRecord";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _teyNumZekh8OmHrykJwdjkPR3bhgzRvyVdBoeJP6PA = (nitroApp) => {
...
const plugins = [
  _teyNumZekh8OmHrykJwdjkPR3bhgzRvyVdBoeJP6PA
];
...
const _lazy_LURa47 = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_BcM43a = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_TTsZe_ = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_kqzFYH = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_NPfbI1 = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_Q3s2eR = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _Wojin1, lazy: false, middleware: true, method: undefined },
  { route: '/api/games/:id', handler: _lazy_LURa47, lazy: true, middleware: false, method: "delete" },
  { route: '/api/games/:id', handler: _lazy_BcM43a, lazy: true, middleware: false, method: "get" },
  { route: '/api/games/:id', handler: _lazy_TTsZe_, lazy: true, middleware: false, method: "put" },
  { route: '/api/games', handler: _lazy_kqzFYH, lazy: true, middleware: false, method: "get" },
  { route: '/api/games', handler: _lazy_NPfbI1, lazy: true, middleware: false, method: "post" },
...
async function readAllGames() {
  try {
    const text = await promises.readFile(DATA_FILE, "utf-8");
...
function writeAllGames(games) {
  const task = writeQueue.then(async () => {
    await promises.mkdir(DATA_DIR, { recursive: true });
    await promises.writeFile(DATA_FILE, JSON.stringify(games, null, 2), "utf-8");
  });
  writeQueue = task.catch(() => void 0);
  return task;
}
function generateId() {
...
function recalcTotalScores(game) {
  game.players.forEach((player) => {
    player.totalScore = game.rounds.reduce(
      (sum, round) => {
        var _a;
        return sum + ((_a = round.scores[player.id]) != null ? _a : 0);
      },
      0
    );
  });
...
const index_post = defineEventHandler(async (event) => {
  ...
  if (body && Array.isArray(body.players) && Array.isArray(body.rounds)) {
    game = {
      id: generateId(),
      name: body.name || (/* @__PURE__ */ new Date()).toISOString(),
      createdAt: Date.now(),
      players: body.players.map((p, idx) => {
        var _a;
        return {
          id: (_a = p.id) != null ? _a : idx,
          name: p.name,
          color: p.color,
          totalScore: 0
        };
      ...
      rounds: body.rounds.map((round, idx) => {
        ...
        return {
          roundNumber: idx + 1,
          scores: round.scores,
          createdAt: (_a = round.createdAt) != null ? _a : Date.now()
        };
      })
    };
...
const getClientManifest = () => import('file:///Users/dukkha/gameRecord/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
